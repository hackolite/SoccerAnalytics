...
class FootballBotSortTracker:
    ...
    def __init__(
        ...
        # player_history[track_id] -> TrackHistory
    ...
    def get_object_tracks(
        ...
        for frame_num, det in enumerate(detections):
            ...
            for box in det.boxes:
                ...
                if cls_name == 'player' and track_id >= 0:
                    tracks["players"][frame_num][track_id] = {"bbox": bbox}
                elif cls_name == 'referee' and track_id >= 0:
                    tracks["referees"][frame_num][track_id] = {"bbox": bbox}
                elif cls_name == 'ball':
                    tracks["ball"][frame_num][1] = {"bbox": bbox}

            # Update ReID history for every tracked player in this frame
